  ...
  <div class="card-body">
    ...
    <form method="POST" id="form-exilednoname" action="{{ URL::current() }}/update/{{ $data->id }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
      ...
      <div class="form-group row">
        ...
        <div class="col-lg-9">
          {{ Html::text('id_access', (isset($data->accesses->name) ? $data->accesses->name : ''), ['class' => $errors->has('id_access') ? 'form-control is-invalid' : 'form-control form-control-solid', 'required' => 'required', 'readonly' => 'readonly']) }}
      ...
      <div class="form-group row">
        ...
        <div class="col-lg-9">
          {{ Html::text('username', (isset($data->username) ? $data->username : ''), ['class' => $errors->has('username') ? 'form-control is-invalid' : 'form-control form-control-solid', 'required' => 'required', 'readonly' => 'readonly']) }}
      ...
      <div class="form-group row">
        ...
        <div class="col-lg-9">
          {{ Html::text('name', (isset($data->name) ? $data->name : ''), ['class' => $errors->has('name') ? 'form-control is-invalid' : 'form-control', 'required' => 'required']) }}
      ...
      <div class="form-group row">
        ...
        <div class="col-lg-9">
          {{ Html::text('email', (isset($data->email) ? $data->email : ''), ['class' => $errors->has('email') ? 'form-control is-invalid' : 'form-control', 'required' => 'required']) }}
      ...
      <div class="form-group row">
        ...
        <div class="col-lg-9">
          {{ Html::text('phone', (isset($data->phone) ? $data->phone : ''), ['class' => $errors->has('phone') ? 'form-control is-invalid' : 'form-control', 'required' => 'required']) }}
