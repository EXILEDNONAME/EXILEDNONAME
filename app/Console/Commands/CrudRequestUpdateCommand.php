...
class CrudRequestUpdateCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'crud:requestupdate
     ...
     * @var string
     */
    protected $description = 'Create a new request update.';
    ...
    protected function getStub()
    {
        ...
        ? config('crudgenerator.path') . '/request-update.stub'
        : __DIR__ . '/../stubs/request-update.stub';
    }
    ...
    {
        return $rootNamespace . '\\' . ($this->option('controller-namespace') ? $this->option('controller-namespace') : 'Http\Requests\Backend\__Main');
    }
