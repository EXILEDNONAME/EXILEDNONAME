...
use App\Http\Requests\Backend\__System\Application\Invoice\StoreRequest;
use App\Http\Requests\Backend\__System\Application\Invoice\UpdateRequest;
...
class InvoiceController extends Controller implements HasMiddleware {
  ...
  function __construct() {
    $this->model = 'App\Models\Backend\__System\Application\Invoice';
    $this->path = 'pages.backend.__system.application.invoice.';
    $this->url = '/dashboard/applications/invoices';
